                    ...
                    <div className="weatherContainer">
                        ...
                        <div className="weatherBlock1">
                            <div className="weatherTextHolder">
                                ...
                                <div className="weatherIntro"><span className="textContent">This fully responsive weather forecast app is using HTML, CSS, and React to deliver quality, visual pleasing web service based on Third Party APIs</span></div>
