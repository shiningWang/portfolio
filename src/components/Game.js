                    ...
                    <div className="gameContainer">
                        ...
                        <div className="gameBlock1">
                            <div className="gameTextHolder">
                                ...
                                <div className="gameIntro"><span className="textContent">This game is using HTML, CSS, and React to demostrate the capability of realtime interactivity in the web-base environment.</span></div>
